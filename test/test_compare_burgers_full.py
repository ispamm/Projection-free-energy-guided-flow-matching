...
def parse_args():
    ...
    parser.add_argument("--n_steps_list", nargs="+", type=int, default=[100],
                        help="Ablation for flow-matching steps. Es: --n_steps_list 50 100 200")
    parser.add_argument("--scheduler_list", nargs="+", type=str, default=["sine"],
                        help="Ablation for scheduler types. Es: --scheduler_list sine linear cosine")
